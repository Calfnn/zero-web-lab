// Organic "liquid camo" pattern rendered as thin green contour lines.
...
//   feFlood + in  -> paint those outlines accent-green
    ...
    >
      <defs>
        ...
        >
          ...
          {/* Colour the outline green */}
          <feFlood floodColor="#89F336" result="green" />
