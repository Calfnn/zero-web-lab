    ...
    <section className="py-24 md:py-32">
      <div className="container-page">
        <div className="relative overflow-hidden rounded-3xl border border-accent/20 bg-surface px-8 py-16 text-center md:py-20">
          ...
          <div
            className="pointer-events-none absolute -bottom-32 left-1/2 -z-10 h-[300px] w-[300px] -translate-x-1/2 rounded-full bg-accent opacity-20 blur-[120px]"
            aria-hidden
          />
          ...
          <ScrambleText
            as="h2"
            text={title}
            className="relative font-sans font-bold text-4xl tracking-tight text-gradient sm:text-5xl md:text-6xl"
          />
